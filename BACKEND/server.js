...
mongoose.connect('mongodb+srv://subhajit799:shuvajit1912@cluster0.2208f.mongodb.net/',{
...
console.error(error);
  ...
  if (!sender) {
    ...
    console.log("reciever Balance after save", receiver);
